# -*- coding: utf-8 -*-
"""clustered_optimizer-50_kms_included.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19BCveZVgsp-ICTDrdntvesqLvfKYSDL5
"""
...
def get_cluster_numbers(path):
  path2 = path[:-9]
  df = pd.concat([pd.read_excel(path).iloc[:,1:] , pd.read_excel(path2 + '.xlsx').iloc[:,1:]] , axis = 0 ,ignore_index=True)
  dfnew = df.transpose()
...
clustered_info_to_excel('/content' , 'all')